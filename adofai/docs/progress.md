...
| 阶段 1：核心骨架 | 进行中 | 深写 `ADOBase`、`ADOClass`、`ADOStartup`、`scrController`、`scrConductor`、`scnGame`、`scnEditor`、`scrLevelMaker`、`scrFloor` | 已完成 [ADOBase](/api/core/ADOBase.md)、[ADOClass](/api/core/ADOClass.md)、[ADOStartup](/api/core/ADOStartup.md)、[scrController](/api/core/scrController.md)、[核心启动与全局访问](/modules/core-startup.md) 和 [运行时控制器状态机](/modules/runtime-controller.md) |
