...
| 阶段 | 状态 | 目标 | 当前记录 |
| --- | --- | --- | --- |
| 阶段 0：文档基础设施与架构侦察 | 进行中 | 建立 docsify 项目、侧边栏、黑白样式、首页、进度页、架构总览和源码地图 | 已确认源码规模和主要类族，已建立文档项目骨架 |
| 阶段 1：核心骨架 | 未开始 | 深写 `ADOBase`、`ADOClass`、`ADOStartup`、`scrController`、`scrConductor`、`scnGame`、`scnEditor`、`scrLevelMaker`、`scrFloor` | 待写 |
